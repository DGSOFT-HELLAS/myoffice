...
const IncomingTaskForm = () => {
  ...
  const onPress = () => {
    navigation.navigate('IncomingTasks', { state: JSON.stringify(state) })
  }
    ...
    <>
      <View style={styles.container}>
        <View style={styles.headerContainer}>
          <BoldText>Αναζήτηση Αναφορά Εργασίας</BoldText>
...
export default IncomingTaskForm;