    ...
    <View style={styles.container}>
      <View style={styles.topView}>
        <View style={styles.topViewLeftInfo}>
          ...
          <Text style={{fontSize: 17}}>
            {routeData['Πελάτης'] ? routeData['Πελάτης'] : 'No Name'}
          </Text>
        </View>
      ...
      <ScrollView style={styles.scrollView}>
        <AddView>
          <AddInput
            title="Πελάτης:"
            value={routeData['Πελάτης']}
            enabled={false}
          />
          <AddInput
            title="Στέλεχος:"
            value={routeData['Στέλεχος']}
            enabled={false}
          />
          <AddInput
            title="Υπηρεσία/Τύπος:"
            value={routeData['Ύπηρεσία/Τύπος']}
            enabled={false}
          />
          <AddInput
            title="Σημείο:"
            value={routeData['Σημείο']}
            enabled={false}
          />
          <CheckboxPaper
            title={'EΟΠΠΥ'}
